...
#define NET_VIRTUAL_TENSOR_NUM  (4)
...
vsi_nn_graph_t * vnn_CreateMobilenetv1Tfite
    (
 ...
 -----------------------------------------*/
    ...
    /*-----------------------------------------
      ...
      output    - [17, 9, 9, 1]
                  ...
                  [32, 9, 9, 1]
    -----------------------------------------*/
    NEW_VXNODE(node[0], VSI_NN_OP_NBG, 1, 4, 0);
...
error:
    ...
    vnn_ReleaseMobilenetv1Tfite( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateMobilenetv1Tfite() */

void vnn_ReleaseMobilenetv1Tfite
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseMobilenetv1Tfite() */
